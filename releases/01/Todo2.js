		...
		switch (msg.$) {
			...
			case 'RemoveTodo':
				...
				var newTodoList = A2(
					...
					model.todoList);
				var newModel = $elm$core$List$isEmpty(newTodoList) ? _Utils_update(
					model,
					{
						todoList: _List_fromArray(
							[
								_Utils_update(
								$author$project$Todo2$defaultTodo,
								{
									startTime: $author$project$Todo2$getNextFreeTime(
										_Utils_update(
											model,
...
var $author$project$Todo2$applySelectedTime = F2(
	function (selectableTimes, model) {
		var userSelectedTime = model.newTodo.startTime;
		return (!userSelectedTime) ? A2(
...
var $author$project$Todo2$timeSelectorGenerator = function (model) {
	var selectableTimes = $author$project$Todo2$getSelectableTimes(model);
	var selectableTimesHtml = A2(
		$elm$core$List$map,
		function (_v0) {
			var newEndTime = _v0.a;
			var selected = _v0.b;
			return A2(
				$elm$html$Html$span,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								function (check) {
									return $author$project$Todo2$NewTodoStartTime(newEndTime);
								})
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								...
								A2(
									...
									model,
									$elm$time$Time$millisToPosix(newEndTime)))
							]))
					]));
		},
		A2($author$project$Todo2$applySelectedTime, selectableTimes, model));
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Todo2$timeSelectorGenerator(model)
															]))
													]))
											])),
